...
import ins.com.ins_project.materialcamera.util.ImageUtil;
import ins.com.ins_project.materialcamera.util.ManufacturerUtil;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  ins.com.ins_project.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new ins.com.ins_project.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof ins.com.ins_project.materialcamera.internal.CameraPreview)
